...
import curso.restaurantes.entidades.ConsultaCodigo;
...
public class RestauranteRest {
	...
	@Consumes("application/json") 
	public Restaurante buscarPorId(ConsultaCodigo consulta){
		return restauranteServicios.buscar(consulta.getCodigo());
	}
	...
	@POST	
	@Consumes("application/json") 
	public Response actualizar(Restaurante restaurante){
		
		try {
			restauranteServicios.actualizar(restaurante);
